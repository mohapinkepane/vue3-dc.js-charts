<template>
  <div>
    <div class="vue-dc-graph-description">
      <b>People by Age</b>
      <a href="https://www.tutorialspoint.com/dcjs/dcjs_bar_chart.htm" target="_blank">
        DC.js - Bar Chart Tutorial</a
      >
      <a
        href="https://github.com/mohapinkepane/vue3-dc.js-charts/blob/master/src/components/BarChart.vue"
        target="_blank"
