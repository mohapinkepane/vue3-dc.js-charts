<template>
  <div>
    <div class="vue-dc-graph-description">
        ...
        <a href="https://www.tutorialspoint.com/dcjs/dcjs_series_chart.htm" target="_blank"> DC.js - Series Chart Tutorial</a>
    </div>
...
function generateSeriesChart() {
  ...
  seriesChart.value
    ...
    .legend(dc.legend().x(200).y(180).itemHeight(13).gap(5).horizontal(1).legendWidth(120)
    .itemWidth(60));
